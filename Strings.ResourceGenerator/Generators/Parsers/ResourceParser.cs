...
internal class ResourceParser
{
    ...
    private static readonly string doubleEscape = Guid.NewGuid().ToString();
    private static readonly string escapedLeftBracket = Guid.NewGuid().ToString();
    private static readonly string escapedRightBracket = Guid.NewGuid().ToString();
    private static readonly string doubleLeftBracket = Guid.NewGuid().ToString();
    private static readonly string doubleRightBracket = Guid.NewGuid().ToString();
    ...
    /// </summary>
    public List<ResourceStringParameter> Parameters { get; } = [];
